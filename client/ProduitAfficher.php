<!DOCTYPE html>
<html lang="en">
<link rel="stylesheet" href="./assets/css/moi.css">
<?php
...
<div class="row bb">
            <div class="col-md-3 bbb">
                <a href="#"> <img src="../assets/images/products/3/bup.png" alt="" style="height: 350px;width:300px" />
...
<?php
$nom_bar=$_GET['name'];
$req="select id_produit,src_image1,src_image2 ,prix_produit,description_produit,nom_produit from produit P inner join images I on I.id_image=P.id_produit where categorie=?";
    ...
    <?php foreach ($bocl as $pro) {?>
        <a id="lientGoToPanier" href="ProduitChoisi.php?ref=<?= $pro->id_produit?>" class=" col-lg-3 col-md-6 col-sm-12">
            <div class="card mx-auto rounded p-2">
                <img src="<?= $pro->src_image2 ?>" alt="produit" onmouseover="this.src='<?=$pro->src_image1?>'" onmouseleave="this.src='<?= $pro->src_image2 ?>'"  class="card-img-top mx-auto" id="pro">
